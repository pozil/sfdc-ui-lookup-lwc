...
| `selection`         | <code>[ LookupSearchResult ] | LookupSearchResult</code> | Lookup initial selection if any. Array for multi-entry lookup or an Object for single entry lookup.                                                                              |
